...
Необхідно створити додаток для подорожей у **React** переписавши готову розмітку. Додаток повинен містити такі сторінки:
...
- усі данні після отримання зберігати у стейті компонента відповідної сторінки
